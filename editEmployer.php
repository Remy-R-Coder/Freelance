...
if(isset($_POST["editEmployer"])){
    ...
    $sql = "UPDATE employer SET Name='$name',email='$email',contact_no='$contactNo' WHERE username='$username'";
        ...
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                <div class="page-header">
                    <h2 style="color:#eacc08;">Edit Profile</h2>
                </div>

                <form id="registrationForm" method="post" class="form-horizontal">
                <div class="form-group">
                    <label class="col-sm-4 control-label" style="color:#a81008">Name</label>
                    <div class="col-sm-5">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" style="color:#a81008">Email address</label>
                    <div class="col-sm-5">
                ...
                <div class="form-group">
                    <label class="col-sm-4 control-label" style="color:#a81008">Contact no.</label>
                    <div class="col-sm-5">
...
<!--Footer-->
<div class="text-center" style="padding:4%;background:#000;color:#fff;margin-top:20px;">
    <div class="row">
            <div class="col-lg-3">
            <h3>Quick Links</h3>
