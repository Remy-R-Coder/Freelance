...
if (isset($_POST["jid"])) {
    // Check for a guest session or create a new one
    if (!isset($_SESSION["guest_id"])) {
        // Assuming you have a function `getOrCreateGuestSession()` in your server.php
        $_SESSION["guest_id"] = getOrCreateGuestSession(); 
    }
    $_SESSION["job_id"] = $_POST["jid"];
    header("location: jobDetails.php");
}

// SQL query to fetch gigs related to the specific type
$sql = "SELECT * FROM job_offer WHERE type='Research/Essays' AND valid=1 ORDER BY job_id DESC";  // Change 'Tutoring' to the appropriate gig type
...
<html>
<head>
    <title>Research & Essays Gigs</title>
    <meta charset="utf-8">
        ...
        <div class="col-lg-9">
            <div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
                <div class="panel panel-succes">
                    <div class="panel-heading"><h3>Research & Essays</h3></div>
